...
var packageBody,ground,side1,side2,side3,body1,body2,body3;
...
function setup() {
	...
	side3 = createSprite(width/2.12,690,150,20);
	...
	body3 = Bodies.rectangle(width/2.12,750,150,20,{isStatic: true});
